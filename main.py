...
def insertdefault():
    ...
    c.execute(
        '''insert into customer(name,address,phone) values('gholam','isf-main street','+98938793412')''')
    c.execute(
        '''insert into customer(name,address,phone) values('saeeid','tehran-kashani','+98938793413')''')
    c.execute(
        '''insert into customer(name,address,phone) values('hamid','kerman-mahan','+98938793414')''')
...
intro_lab = Label(root, text="Ali Zahedi-9813016013")
createdb_but = Button(
